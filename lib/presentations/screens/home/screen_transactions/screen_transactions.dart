...
class AllTransactions extends StatelessWidget {
  ...
  final Box<Transactions> transactions = Hive.box<Transactions>(transactionBox);
  final Box<ReminderDb> reminder = Hive.box<ReminderDb>(reminderBox);
  IconData? myIcon;
  Widget? myFields;
    ...
    return SingleChildScrollView(
      ...
      child: BlocBuilder<TransactionCubit, TransactionState>(
        builder: (context, state) {
          List<Transactions> boxList = transactions.values.toList();
